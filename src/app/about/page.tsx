        ...
        <div className="space-y-12">
            ...
            <Card className="flex flex-col">
              ...
              <CardFooter>
                <StatsLink
                  ...
                  target="_blank"
                >
                  Join the Fil+ storage provider registry
                </StatsLink>
              </CardFooter>
            </Card>
            <Card className="flex flex-col">
          ...
          <div className="md:col-span-2 lg:col-span-4 space-y-8">
            <div className="space-y-6">
              <h2 className="font-semibold text-lg">Filecoin Plus</h2>
              <div className="space-y-4 max-w-prose">
                <p>
                  Filecoin Plus is a layer of social trust on top of the
                  Filecoin Network designed to incentivize the storage of real
                  data. Root key-holders, allocators, clients, and storage
                  providers interact through the allocation and spending of
                  DataCap. For more details about the Fil+ program, visit the{" "}
                  {contentLink.filecoin_docs}
                </p>
                <p>
                  Clients looking to utilize storage on the network apply to
                  receive DataCap from Allocators, which can be used to
                  incentivize storage providers to make storage deals.
                  Allocators are community-elected trustees responsible for
                  allocating DataCap to parties storing useful data on the
                  network. Storage Providers that receive DataCap get a 10x
                  boost to their quality-adjusted power for the storage space
                  offered in that deal, increasing their block reward share in
                  the network. This creates a mechanism that incentivizes all
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 max-w-prose">
                <p>
                  The goal of this site is to provide metrics, insights, and
                  audit accountability tools for the Filecoin Plus community.
                  You can see health statistics of the overall program, along
                  with tables of data to track interactions between stakeholders
                  (Allocators, Clients, and Storage Providers).
                </p>
                <p>
