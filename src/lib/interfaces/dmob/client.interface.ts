import {IAllowanceArray, IApiListCountable, IApiListResponse} from "@/lib/interfaces/dmob/dmob.interface";
...
export interface IClientResponse extends IApiListResponse<IClientDeal>, IApiListCountable{
  name: string
...
export interface IClientAllocationsResponse extends IApiListResponse<IClient>, IApiListCountable {
  totalRemainingDatacap: string
  clientsWithActiveDeals: string
  countOfClientsWhoHaveDcAndDeals: string
  numberOfClients: string
