    ...
    {props.value?.map((_, i) => (
      <SliderPrimitive.Thumb key={i}
                             ...
                             className={cn(
                               ...
                               {"before:content-[attr(data-popover)] before:absolute before:bottom-6 before:-translate-x-[25%]": popoverPlacement === "top"},
                               {"before:content-[attr(data-popover)] before:absolute before:top-6 before:-translate-x-[25%]": popoverPlacement === "bottom"}
                             )}/>
    ))}
  </SliderPrimitive.Root>
))
